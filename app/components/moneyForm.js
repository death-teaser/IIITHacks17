...
class moneyForm extends Component {
    ...
    onButtonPress3() {
        ...
        axios.get('http://192.168.43.193:8000/donate?donation_type=1&donation_description='+this.props.description+'&donation_amount='+this.props.type+'&donation_to=udaan')
